...
urlpatterns = [
    ...
    # path("peliculas/detail/<int:pk>", views.peliculas_detail, name="peliculas_detail"),
    path("peliculas/detail/<int:pk>", views.PeliculaDetail.as_view(), name="peliculas_detail"),
    # path("director/detail/<int:pk>", views.director_detail, name="director_detail"),
    path("director/detail/<int:pk>", views.DirectorDetail.as_view(), name="director_detail"),
    # path("peliculas/update/<int:pk>", views.peliculas_update, name="peliculas_update"),
    path("peliculas/update/<int:pk>", views.PeliculaUpdate.as_view(), name="peliculas_update"),
    # path("peliculas/delete/<int:pk>", views.peliculas_delete, name="peliculas_delete"),
